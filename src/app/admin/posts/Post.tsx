...
const DeleteModal = ({onClick} : {onClick: ()=>void}) => {
  ...
  return (
    <div className="flex gap-2 flex-col w-[30vw]">
      ...
      <p>
        This will permamently delete all the data, images and all information
        about this post.
      </p>
      <div className="flex gap-4">
        <Button
          variant="secondary"
          className="bg-nord-14 hover:bg-green-500 text-xl"
          onClick={onClick}
        >
          Yes
        </Button>
        <Button
          variant="secondary"
          className="bg-nord-11 hover:bg-red-400 text-xl"
          onClick={() => closeModal()}
        >
          No
        </Button>
