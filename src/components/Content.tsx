...
export default function Content({ content }: { content: Partial<PostContentBlock> & { altText?: string } }) {
    switch (content.type) {
        case "h1":
        ...
        case "video":
            return <video src={content.content as string} controls width="350" height="350" className="shadow-gray-900 shadow-lg" />
        case "file":
            return (
