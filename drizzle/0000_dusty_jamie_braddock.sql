...
CREATE TABLE IF NOT EXISTS "post_content_blocks" (
	...
	CONSTRAINT "post_content_blocks_post_id_position_pk" PRIMARY KEY("post_id","position")
);
--> statement-breakpoint
...
CREATE TABLE IF NOT EXISTS "project_content_blocks" (
	...
	"content" text NOT NULL,
	"position" integer NOT NULL,
	CONSTRAINT "project_content_blocks_project_id_position_pk" PRIMARY KEY("project_id","position")
);
--> statement-breakpoint
...
--> statement-breakpoint
DO $$ BEGIN
 ALTER TABLE "projects" ADD CONSTRAINT "projects_author_id_user_id_fk" FOREIGN KEY ("author_id") REFERENCES "public"."user"("id") ON DELETE no action ON UPDATE no action;
EXCEPTION
 WHEN duplicate_object THEN null;
END $$;
--> statement-breakpoint
...
CREATE UNIQUE INDEX IF NOT EXISTS "unique_project_position" ON "project_content_blocks" USING btree ("project_id","position");